...
namespace SCRghelp.Infrastructure
{
    public class RegistryHelperClass
    {
        ...
        public string SupervisorApiKey
        {
            get { return regMapper.Getvalue("SupervisorApiKey").ToString(); }
            set { regMapper.Setvalue("SupervisorApiKey", value); }
        }
        ...
        public int HouseKeepingCount
        {
            get { return Convert.ToInt32(regMapper.Getvalue("HouseKeepingCount")); }
            set { regMapper.Setvalue("HouseKeepingCount", value.ToString()); }
        }
